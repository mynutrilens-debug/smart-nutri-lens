...
import { Send, Sparkles, Trash2, Lock } from "lucide-react";
...
function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-zinc-950 text-white">
      {/* Header */}
      <header className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-zinc-950/80 backdrop-blur sticky top-0 z-10">
      ...
      {/* Input */}
      <div
        className="fixed left-0 right-0 z-20 px-3 pb-3 pt-2 bg-gradient-to-t from-zinc-950 via-zinc-950/95 to-zinc-950/0"
